...
public class CreateGrabberMechanism extends CreateMechanismBase {
    ...
    public void create(){
        ...
        op.getGamepadButton(GamepadKeys.Button.RIGHT_BUMPER).toggleWhenPressed(grabberOpenCommand, grabberCloseCommand);
                //.and(toggleWhenPressed(grabberLeftCloseCommand,grabberLeftCommand));
